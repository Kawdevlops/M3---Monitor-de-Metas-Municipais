...
```
cd existing_repo
git remote add origin http://codigoaberto.prefeitura.sp.gov.br/smsub/m3-monitor-de-metas-municipais.git
git branch -M main
...
- [ ] [Set up project integrations](http://codigoaberto.prefeitura.sp.gov.br/smsub/m3-monitor-de-metas-municipais/-/settings/integrations)
